...
import { ChevronDown, ShieldCheck, Wallet, X } from "lucide-react";
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
				...
				>
					...
					<span className="text-xl font-bold tracking-tight">
						Stack<span className="text-[#f7931a]">BTC</span>
					</span>
				</button>
				...
				<div className="flex items-center gap-3 relative" ref={menuRef}>
					...
					>
						...
						<ChevronDown
							className={`w-3 h-3 text-slate-500 transition-transform ${showWalletMenu ? "rotate-180" : ""}`}
						/>
					</button>
